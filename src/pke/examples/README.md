HESEA Lattice Cryptography Library - Examples
=============================================
...
===================
This document describes the examples included with the HESEA lattice crypto library.
...
- [pre-buffer.cpp](src/pke/examples/pre-buffer.cpp): demonstrates use of HESEA for encryption, re-encryption and decryption of packed vector of binary data
- [pre-text.cpp](src/pke/examples/pre-text.cpp): demonstrates use of HESEA for encryption, re-encryption and decryption of text
